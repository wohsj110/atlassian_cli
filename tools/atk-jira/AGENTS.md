...
Codex entrypoint for the atk-jira tool.
...
This file is an index only. Keep atk-jira-specific guidance in the development guide or command specs, and keep shared conventions in the linked shared sources.
