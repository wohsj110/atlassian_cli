...
Codex entrypoint for atk-jira command-surface work.

## Command Surface

Local source of truth: tools/atk-jira/internal/cmd/GUARDRAILS.md
Local convenience copy, if present: `GUARDRAILS.md`

## Output Contract

Local source of truth: tools/atk-jira/internal/cmd/OUTPUT_SPEC.md
Local convenience copy, if present: `OUTPUT_SPEC.md`

## atk-jira Development

Local source of truth: tools/atk-jira/docs/development.md
...
This file is an index only. Keep command-surface rules in the specs above.
