...
Claude entrypoint for the atk-cfl tool.

## Start Here

Local source of truth: tools/atk-cfl/docs/development.md
...
This file is an index only. Keep atk-cfl-specific guidance in the development guide and shared conventions in the linked shared sources.
